...
# To toggle between test cases...
Inside of the `src/App.js` file, comment in/out the different `cx` implementations.

# With memoized classname
![Performance with memoized classname](/assets/memoized.png)

# Without memoized classname
![Performance without memoized classname](/assets/unmemoized.png)
